...
Firmware_Diy() {
	...
	coolsnowwolf/lede:master)
		...
		AddPackage git lean luci-app-unblockneteasemusic immortalwrt-collections master
		AddPackage git lean luci-app-adblock-plus small-5 master
